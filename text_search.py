...
def get_reviews(index, original, tfidf, similar, name):
    reviews = []
    cosine = []
    table = []
    names = []
    ...
    return reviews, cosine, table, names
...
def put(reviews, cosine, tables, names):
    result = []
...
def controller(text):
    ...
    reviews, cosine, table, final_names = get_reviews(index, original, tf_idf, similar, names)
    result = put(reviews, cosine, table, final_names)
    return result

text = "Girl with ghost and movie is bad" 
